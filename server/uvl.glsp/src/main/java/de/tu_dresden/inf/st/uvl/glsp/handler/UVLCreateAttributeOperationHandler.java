...
public class UVLCreateAttributeOperationHandler
            ...
            .orElseThrow(
                () ->
                    new IllegalStateException(
                        "No parent feature found for attribute with container ID: " + containerId));
  ...
  protected Map<String, Attribute<?>> resolveTargetAttributes(
            ...
            .orElseThrow(
                () ->
                    new IllegalArgumentException(
                        "Could not resolve target attribute from container ID: " + containerId));

    return GModelUtil.asAttributeMap(resolvedAttribute.attribute())
        .orElseThrow(
            () ->
                new IllegalArgumentException(
                    "Target attribute does not support sub attributes: "
