...
public class UVLToolPaletteItemProvider implements ToolPaletteItemProvider {
  ...
  public List<PaletteItem> getItems(Map<String, String> args) {
    return List.of(elements(), relations(), constraints());
  }

  protected PaletteItem elements() {
    List<PaletteItem> elements =
        List.of(
  ...
  protected PaletteItem relations() {
    ...
    return PaletteItem.createPaletteGroup(
        "relations", "Relations", relations, "symbol-property", "B");
  }
   ...
   *
   * <p>The returned palette item, when selected, triggers the creation of a node of the specified
   * type in the diagram.
   *
   ...
   *
   * <p>The returned palette item, when selected, triggers the creation of an edge of the specified
   * type in the diagram.
   *
