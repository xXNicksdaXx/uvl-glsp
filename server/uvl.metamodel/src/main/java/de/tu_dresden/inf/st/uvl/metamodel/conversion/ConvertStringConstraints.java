...
import de.tu_dresden.inf.st.uvl.metamodel.model.constraint.EqualEquationConstraint;
...
public class ConvertStringConstraints implements IConversionStrategy {
    ...
    public void convertFeatureModel(final FeatureModel rootFeatureModel, final FeatureModel featureModel) {
        ...
        rootFeatureModel.getOwnConstraints().removeIf(this::containsStringEqualityExpression);
    ...
    private void replaceStringAggregateFunctionInExpression(final Expression parentExpression,
        ...
        final Expression newExpression = new LiteralExpression(new Attribute<>(Constants.TYPE_LEVEL_LENGTH, 0L, relevantFeature));
