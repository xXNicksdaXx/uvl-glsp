...
public class Import {
     ...
     * @param alias     The alias of the import (maybe null)
     */
    ...
    /**
     * Boolean depending on if the import is actually used. Meaning if the root
    ...
    /**
     * Set boolean if this submodel is used (referenced) anywhere.
     *
