...
public class UVLCreateGroupCardinalityEdgeOperationHandler
    extends UVLCreateRelationEdgeOperationHandler {
  ...
  protected void executeCreation(CreateEdgeOperation operation) {
    ...
    Optional<Group> existingGroup =
        findExistingGroup(sourceFeature, Group.GroupType.GROUP_CARDINALITY);
