...
public class BPDiagramConfiguration extends UVLDiagramConfiguration {
    ...
    public List<ShapeTypeHint> getShapeTypeHints() {
        ...
        replaceTypeHints(shapeTypeHints, List.of(
                ...
                new ShapeTypeHint(UVLModelTypes.FEATURE,
                        ...
                        List.of(UVLModelTypes.FEATURE, BPModelTypes.B_THREAD, UVLModelTypes.ATTRIBUTE, UVLModelTypes.CARDINALITY_LABEL))
        ));

        shapeTypeHints.addAll(List.of(
