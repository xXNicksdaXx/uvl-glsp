...
import de.tu_dresden.inf.st.uvl.metamodel.config.Configuration;
...
import static de.tu_dresden.inf.st.uvl.metamodel.util.Util.addNecessaryQuotes;
...
public class Feature implements VariableReference {
    ...
    public Feature(String name) {
        ...
        children = new LinkedList<>() {
            ...
            class GroupIterator implements ListIterator<Group> {
                private final ListIterator<Group> itr;
                Group lastReturned;
     ...
     * yourself and not with the {@link UVLModelFactory} be careful to
     * the namespaces and set them correct. See {@link Feature#getNameSpace()}
     ...
     *
     * @param featureType the type of the feature (if supported by the language level)
     */
    ...
    /**
     * This method returns an uvl valid name for the feature. This name is unique
     ...
     *
     * @return An uvl valid unique name for the feature
     */
    public String getFullReference() {
        String fullReference;
        // .hashCode() does vary in length, this might lead to naming conflicts,
        // therefore make ids all the same length by adding zeros
        ...
        if ("".equals(nameSpace)) {
            ...
            // this case means, the feature is in an imported sub feature model and therefore
     ...
     * @param currentAlias  the namespace from the one referencing the feature to the
     *                      feature
    ...
    private String cardinalityToString() {
        ...
        return String.format(" cardinality %s", cardinality);
    }
